...
export abstract class RestStatusMapper {
  ...
  static getStatusByException(exception: AbstractException) {
    return RestStatusMapper._map.get(exception.code) ?? HttpStatus.INTERNAL_SERVER_ERROR;
  }
}
